...
(1, 'Downtown Charging Station', 37.7749, -122.4194, 'Level 2', 'United States', 'California', 'San Francisco'),
(2, 'Mall Parking Garage', 37.7849, -122.4094, 'DC Fast', 'United States', 'California', 'San Francisco'),
(3, 'Airport Terminal A', 37.7949, -122.3994, 'Level 2', 'United States', 'California', 'San Francisco'),
(4, 'Shopping Center', 37.8049, -122.3894, 'Level 1', 'United States', 'California', 'San Francisco'),
(5, 'Office Building', 37.8149, -122.3794, 'DC Fast', 'United States', 'California', 'San Francisco');
...
(1, 11.0170, 76.9635, 'active', 'Need help, battery low near Gandhipuram!', 'email:user1@example.com'),
(2, 11.0183, 76.9558, 'active', NULL, 'phone:+919876543210'),
(3, 11.0350, 77.0000, 'active', 'Can assist near RS Puram!', 'in-app');
