...
def get_stations_from_mock() -> List[Station]:
    ...
    try:
        ...
        if os.path.exists(mock_data_path):
            ...
            return [
                Station(id=1, name="Downtown Station", latitude=37.7749, longitude=-122.4194, energy_type="Level 2", available=True),
                Station(id=2, name="Mall Station", latitude=37.7849, longitude=-122.4094, energy_type="DC Fast", available=False),
                Station(id=3, name="Airport Station", latitude=37.7949, longitude=-122.3994, energy_type="Level 2", available=True)
            ]
    except Exception as e:
